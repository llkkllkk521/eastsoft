    ...
    <div class='panel-body'>
      ...
      <div class='categoryInfo'>
        ...
        <div class='form-group'> 
          ...
          <div class='col-md-9' style="padding-top:6px;"><?php commonModel::printLink('file', 'browse', "objectType=category&objectID=$category->id&isImage=1", '上传图片', "data-toggle='modal'");?></div>
        </div>
      </div>
      <div class='categoryInfo'>
      ...
      <?php foreach ($attr as $key => $value) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="attr_name[]" class="form-control" value="<?php echo $value->name ?>"/>
          </div>
          <div class="col-md-2">
            <a href="javascript:;">
        ...
        <?php foreach ($value->detail as $detail) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <input type="hidden" name="detail_attr[]" value="<?php echo $value->id ?>"/>
              <input type="text" name="detail_value[]" class="form-control" value="<?php echo $detail->value ?>"/>
            </div>
            <div class="col-md-2">
              <a href="javascript:;">
