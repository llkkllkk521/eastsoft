...
$lang->user->control->menus[60] = '<i class="icon-comment-alt"></i> 我的回帖 <i class="icon-chevron-right"></i>|user|reply';
$lang->user->control->menus[71] = '<i class="icon-comment-alt"></i> 满意度调查 <i class="icon-chevron-right"></i>|user|surveyonestep';
$lang->user->control->menus[72] = '<i class="icon-comment-alt"></i> 活动预告 <i class="icon-chevron-right"></i>|user|hdyg';
$lang->user->control->menus[73] = '<i class="icon-comment-alt"></i> 专属文档<i class="icon-chevron-right"></i>|user|zswd';
...
$lang->user->mydList['非常满意'] = '非常满意';
$lang->user->mydList['比较满意']  = '比较满意';
$lang->user->mydList['一般']  = '一般';
$lang->user->mydList['不满意']  = '不满意';
$lang->user->mydList['非常不满意']  = '非常不满意';

$lang->user->membertype['zd'] = '个人/公司用户';
$lang->user->membertype['dls'] = '代理/方案公司';

$lang->user->position = '职位';
$lang->user->productserver = '主要产品或服务';
$lang->user->application = '感兴趣的应用';
$lang->user->applicationList['家电'] = '家电';
$lang->user->applicationList['小家电'] = '小家电';
$lang->user->applicationList['汽车电子'] = '汽车电子';
$lang->user->applicationList['工业控制'] = '工业控制';
$lang->user->applicationList['智能仪表'] = '智能仪表';
$lang->user->applicationList['其他'] = '其他';
$lang->user->other = '其他';
$lang->user->informupdate = '通知更新';
$lang->user->informupdateList['month'] = '每月定期通知';
$lang->user->informupdateList['week'] = '每周定期通知';
$lang->user->informupdateList['timely'] = '即时接受通知';
$lang->user->informupdateList['no'] = '不接受更新通知';
$lang->user->utype = '身份';
