  ...
  <div class='panel-body'>
  	...
  	<form method='post' role='form' id='ajaxForm'>
    	<table width="100%">
    		<tr>
    			<td width="10%">调查名称</td>
    			<td><?php echo html::input('title', '', "class='title form-control' placeholder=''");?></td>
    		</tr>
    		<tr>
    			<td>调查介绍</td>
    			<td><?php echo html::textarea('intro', '', "rows='10' class='form-control'");?></td>
    		</tr>
    		<tr>
    			<td>开启状态</td>
    			<td><?php echo html::radio('status', $lang->survey->statusList, 'on');?></td>
    		</tr>
    		<tr>
    			<td>调查类型</td>
    			<td><?php echo html::radio('type', $lang->survey->typesList, 'zd');?></td>
    		</tr>
    		<tr>
    			<td>开始时间</td>
    			<td class="input-append date">
    			<?php echo html::input('beginDate', date('Y-m-d H:i'), "class='form-control'");?>
    		...
    		<tr>
    			<td>结束时间</td>
    			<td class="input-append date">
    			<?php echo html::input('endDate', date('Y-m-d H:i'), "class='form-control'");?>
    			<span class='add-on'><button class="btn btn-default" type="button"><i class="icon-calendar"></i></button></span>
    			</td>
    		</tr>
    		<tr>
