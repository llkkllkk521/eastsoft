...
$config->rights->guest['article']['videodetail']   = 'videodetail';
$config->rights->guest['article']['read']   = 'read';
...
$config->rights->guest['product']['showall'] = 'showall';

$config->rights->guest['zhaopin']['index']    = 'index';
$config->rights->guest['zhaopin']['browse']   = 'browse';
$config->rights->guest['zhaopin']['view']     = 'view';
$config->rights->guest['zhaopin']['redirect'] = 'redirect';
$config->rights->guest['zhaopin']['getarea'] = 'getarea';

$config->rights->guest['consulting']['index']     = 'index';
$config->rights->guest['consulting']['post']     = 'post';
$config->rights->guest['consulting']['verifycode'] = 'verifycode';
$config->rights->guest['consulting']['getverifycode'] = 'getverifycode';
...
$config->rights->member['user']['hdyg']      = 'hdyg';
$config->rights->member['user']['zswd']      = 'zswd';
$config->rights->member['user']['surveyonestep']      = 'surveyonestep';
$config->rights->member['user']['surveytwostep']      = 'surveytwostep';
$config->rights->member['user']['surveythreestep']      = 'surveythreestep';
$config->rights->member['user']['savesurveycontent']      = 'savesurveycontent';
