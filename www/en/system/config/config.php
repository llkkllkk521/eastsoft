...
/* The basic settings. */
$config = new config();
$config->version     = '5.0';             // The version number, don't change.
...
define('TABLE_ZHAOPIN',        $config->db->prefix . 'zhaopin');
define('TABLE_REGIONS',        $config->db->prefix . 'regions');
define('TABLE_SURVEY_CONTENT_TYPE',        $config->db->prefix . 'survey_content_type');
define('TABLE_SURVEY',         $config->db->prefix . 'survey');
define('TABLE_SURVEY_CONTENT', $config->db->prefix . 'survey_content');
define('TABLE_CONSULTING',        $config->db->prefix . 'consulting');
