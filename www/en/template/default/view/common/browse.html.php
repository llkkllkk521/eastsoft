        ...
        <div class="mid">
          ...
          <div class="block" style="height: auto">
            ...
            <div class="ctgs">
              <div class="ctg-sub1">
                <!-- 二级分类不可点击 -->
                <a class='name' ><?php echo $sub1->name; ?>333</a>
              </div>
              <?php foreach ($sub1->sub as $sub2) { ?>
              <?php
              ...
              ?>
                <a class="ctg-sub2" href="<?php echo $webRoot . 'en/index.php/article/c' . $sub2_id . '.html'; ?>">
                  <?php echo $sub2->name; ?>
                </a>
              <?php } ?>
            </div>
