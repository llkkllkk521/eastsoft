      ...
      <div class='panel'>
        ...
        <div class='panel-body'>
          <form method='post' id='ajaxForm' class='form form-horizontal' data-checkfingerprint='1'>
            ...
            <div class='form-group'>
              <label for='company' class='col-md-2 col-sm-3 control-label'><?php echo $lang->user->utype;?></label>
              <div class='col-md-6 col-sm-6'>
                <?php echo html::radio('utype', $lang->user->membertype, $user->utype);?>
              </div>
            </div>
            <div class='form-group'>
              <label for='address' class='col-md-2 col-sm-3 control-label'><?php echo $lang->user->addressHistory;?></label>
              <div class='col-md-6 col-sm-6'>
            ...
            <div class='form-group'>
              <label for='qq' class='col-md-2 col-sm-3 control-label'><?php echo $lang->user->position;?></label>
              <div class='col-md-6 col-sm-6'>
                <?php echo html::input('position', $user->position, "class='form-control'");?>
              </div>
            </div>
            <div class='form-group'>
              <label for='gtalk' class='col-md-2 col-sm-3 control-label'><?php echo $lang->user->company;?></label>
              <div class='col-md-6 col-sm-6'>
            ...
            <div class='form-group'>
              <label class="col-md-2 col-sm-3 control-label"><?php echo $lang->user->productserver;?></label>
              <div class='col-md-6 col-sm-6'><?php echo html::textarea('productserver', $user->productserver, "rows='2' class='form-control'");?></div>
            </div>
            <div class='form-group'>
              <label class="col-md-2 col-sm-3 control-label"><?php echo $lang->user->application;?></label>
              <div class='col-md-6 col-sm-6'><?php echo html::checkbox('application', $lang->user->applicationList, $user->application);?></div>
            </div>
            <div class='form-group'>
              <label class="col-md-2 col-sm-3 control-label"><?php echo $lang->user->other;?></label>
              <div class='col-md-6 col-sm-6'><?php echo html::textarea('other', $user->other, "rows='2' class='form-control'");?></div>
            </div>
            <div class='form-group'>
              <label class='col-md-2 col-sm-3 control-label'>更新通知</label>
              <div class='col-md-6 col-sm-6'><?php echo html::radio('informupdate', $lang->user->informupdateList, $user->informupdate);?></div>
            </div>
            <div class='form-group'>
