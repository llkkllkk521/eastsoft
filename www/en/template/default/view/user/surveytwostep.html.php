          ...
          <form class="survey-all" method="post" action="/index.php/user-surveythreestep.html">
	          ...
	          <div class="survey s<?php echo $k11;?>" style="<?php echo $k11==1?'':'display:none;';?>">
		          	...
		          	<table class="surveytitle">
		          		<tr><td width="25%" style="border-bottom:3px solid #077ac7;"><?php echo $survey->title; ?></td><td width="65%" align="right" style="border-bottom:1px solid #6f6f6f;color:#077ac7;"><?php echo $s->theme;?></td><td align="right" style="border-bottom:1px solid #6f6f6f;">调查进度<?php echo $k11.'/'.$total?></td></tr>
		          	</table>
	          		<?php foreach($this->user->getSurveyList($s->theme, $s->parent) AS $k2=>$v):?>
	            		<?php $k22=$k2+1;?>
