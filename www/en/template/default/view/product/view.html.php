  ...
  <div class="main-box">
    ...
    <div class="left">
      <?php foreach ($children as $sub1) { ?>
        <a href="<?php echo $siteRoot . "en/index.php/product/c" . $sub1->id . ".html"; ?>" class='sub1'>
        ...
        <?php foreach ($sub1->sub as $sub2) { ?>
          <a href="<?php echo $siteRoot . "en/index.php/product/c" . $sub2->id . ".html"; ?>" class='sub2'>
            <?php echo $sub2->name; ?>
          </a>
        <?php } ?>
        </div>
      ...
      <div class="product-desc">
        ...
        <div class="product-right-top">
          ...
          <?php foreach ($linked_article as $la) { ?>
            <p>
              <a href="<?php echo $this->createLink('index.php/article', 'view', '$articleID=' . $la->id) ?>">
                <?php echo $la->title; ?>
              </a>
            </p>
          <?php } ?>
