...
<div class="main-content">
  ...
  <div class="main-box">
    ...
    <div class="right">
      ...
      <?php }else{ ?>
      <table width="100%">
      	<tr><td width="75%" align="left">招聘邮箱：<font color=" #077ac7">job@essemi.com</font></td><td align="right" height="30" ><span><?php $this->loadModel('zhaopin')->cateList();?></span><span class="region-search">搜索</span></td></tr>
      </table>
      <table class="zhaopin">
