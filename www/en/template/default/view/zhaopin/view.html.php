  ...
  <div class="main-box">
    ...
    <div class="right">
      ...
      <table class="zhaopinview">
      	...
      	<tr><td><?php echo $region;?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $article->department;?>&nbsp;&nbsp;|&nbsp;&nbsp;招聘人数：<?php echo is_numeric($article->total_number) ? $article->total_number.'人' : $article->total_number;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="color:#ccc;">发布时间：<?php echo substr($article->editedDate, 0, 10);?></font></td><td style="padding-right:10px;" align="right">招聘邮箱：<a href="mailto:job@essemi.com">job@essemi.com</a></td></tr>
	  </table>
