...
<div class="main-content">
  ...
  <div class="main-box">
    ...
    <div class="right">
      ...
      <?php }else{ ?>
      <table width="100%">
      	<tr><td width="75%" align="left">招聘邮箱：<font color=" #077ac7"><a href="mailto:job@essemi.com">job@essemi.com</a></font></td><td align="right" height="30" ><span><?php $this->loadModel('zhaopin')->cateList();?></span><span class="region-search">筛选</span></td></tr>
      </table>
      <table class="zhaopin">
