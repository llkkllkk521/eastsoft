...
<!--          --><?php //endif;?>
      ...
      <section class='article-content'>
		...
		<tr>
			...
			<td>
			    ...
			    <?php echo '<span style="padding:0 6px 0 0;"><a href="/product/'.$product->id.'.html" target="_blank">'.$product->name.'</a></span>';?>
			    <?php endforeach;?>
			</td>
			<!-- <td>8位高抗干扰MCU</td> -->
		</tr>
      ...
      <?php else:?>
	  		...
	  		<?php if($this->loadModel('user')->isLogon()):?>
			      ...
			      <?php endif;?>
      		<?php else:?>
      		<?php echo html::a('/index.php/user-login', $lang->article->loginviewfile);?>
      		<?php endif;?>
      		</section>
      <?php endif;?>
      <footer>
